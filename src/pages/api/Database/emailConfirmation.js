...
const sendConfirmationEmail = async (formData) => {
  ...
  const backendMailOptions = {
    ...
    html: `<div>Hi Backend Team,</div><p>Alowing details:</p><p>Name: ${formData.name}</p><p>Email: ${formData.email}</p><p>Message: ${formData.message}</p>`,
  };
