...
const Emipopup = dynamic(() => import("../../CoursePage/EMIPopup/Emipopup"));
import Modal from "react-modal";
import { FaGlobe } from "react-icons/fa6";
import { FaRegCreditCard } from "react-icons/fa";

const FeeSectionCopy = ({
  Fee,
  dataScience,
  WeekdayDate,
  WeekendDate,
  ...
  const openEmiPopup = useCallback(() => setEmiPopupIsOpen(true), []);
  const closeEmiPopup = useCallback(() => setEmiPopupIsOpen(false), []);

  const scholarshipImage = useMemo(() => (
    <Image
      src={
        devopfee
          ? "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/cloud-computing/devop-fee.webp"
          : "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/cloud-computing/devop-fee.webp"
      }
      height="170"
