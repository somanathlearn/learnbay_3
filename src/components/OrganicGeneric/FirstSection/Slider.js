    ...
    <div className={styles.SliderWrap}>
      ...
      >
        <SwiperSlide className={styles.slide}>
          ...
          >
            <img
              src="https://d32and0ii3b8oy.cloudfront.net/web/s3_main/1.webp"
              alt="Content Image"
        ...
        <SwiperSlide className={styles.slide}>
          ...
          >
            <img
              src="https://d32and0ii3b8oy.cloudfront.net/web/s3_main/2.webp"
              alt="Content Image"
              style={{ width: "100%", padding: "10px" }}
            />
          </a>
        ...
        <SwiperSlide className={styles.slide}>
          ...
          >
            <img
              src="https://d32and0ii3b8oy.cloudfront.net/web/s3_main/3.webp"
              alt="Content Image"
              style={{ width: "100%", padding: "10px" }}
            />
          </a>
        ...
        <SwiperSlide className={styles.slide}>
          ...
          >
            <img
              src="https://d32and0ii3b8oy.cloudfront.net/web/s3_main/5.webp"
              alt="Content Image"
              style={{ width: "100%", padding: "10px" }}
            />
          </a>
        ...
        <SwiperSlide className={styles.slide}>
          ...
          >
            <img
              src="https://d32and0ii3b8oy.cloudfront.net/web/s3_main/6.webp"
              alt="Content Image"
              style={{ width: "100%", padding: "10px" }}
            />
          </a>{" "}
        ...
        <SwiperSlide className={styles.slide}>
          ...
          >
            <img
              src="https://d32and0ii3b8oy.cloudfront.net/web/s3_main/7.webp"
              alt="Content Image"
              style={{ width: "100%", padding: "10px" }}
            />
          </a>{" "}
        ...
        <SwiperSlide className={styles.slide}>
          ...
          >
            <img
              src="https://d32and0ii3b8oy.cloudfront.net/web/s3_main/8.webp"
              alt="Content Image"
              style={{ width: "100%", padding: "10px" }}
            />
          </a>{" "}
        ...
        <SwiperSlide className={styles.slide}>
          ...
          >
            <img
              src="https://d32and0ii3b8oy.cloudfront.net/web/s3_main/9.webp"
              alt="Content Image"
              style={{ width: "100%", padding: "10px" }}
            />
          </a>{" "}
        ...
        <SwiperSlide className={styles.slide}>
          ...
          >
            <img
              src="https://d32and0ii3b8oy.cloudfront.net/web/s3_main/10.webp"
              alt="Content Image"
              style={{ width: "100%", padding: "10px" }}
            />
          </a>
