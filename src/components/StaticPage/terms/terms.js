...
function terms() {
  return (
    <section className={styles.terms}>
        <div className={styles.BackT}><h1><b>Terms and Conditions</b></h1></div>
        <div className={styles.termsInner}>
        <h2 className={styles.head}>Welcome to Learnbay!</h2>
...
<h3 className={styles.top}>*Why the significance of understanding the Terms and Conditions and any potential implications is necessary?</h3>
...
<h3 className={styles.top}>Please read these Terms and Conditions very carefully, before start using our website/LMS.</h3>
...
<h3 className={styles.top}>*What are cookies?</h3>
...
<h3 className={styles.top}>*User Conduct Agreement -</h3>
...
<h3 className={styles.top}>Content Liabilities (For User)</h3>
...
<h3 className={styles.top}>*Copyright License</h3>
...
<h2 className={styles.top}># It is unlawful and plagiarism is an offense.</h2>
<h3 className={styles.top}>*Why it's important to read the content liability?</h3>
...
<h4 className={styles.top}>Note:</h4>
...
<h4 className={styles.top}>*Rights Reserved</h4>
...
<h3 className={styles.top}>Hyperlinks</h3>
...
<h4 className={styles.top}>Claims of Intellectual property violations</h4>
...
<h3 className={styles.top}>Transaction terms</h3>
...
<h3 className={styles.top}>*I-llegitimate link voiding</h3>
...
<h4 className={styles.top}>*Terms and Conditions evolvement:-</h4>
...
<h3 className={styles.top}>*What are the termination terms?</h3>
...
<h3 className={styles.top}>Terms of Career Assistance Related Services:</h3>
...
<h3 className={styles.top}>*Terms of service explained</h3>
...
<h4 className={styles.top}>Security breach:-</h4>
...
<h4 className={styles.top}>*Please be aware of the terms and limitations.</h4>
...
<h4 className={styles.top}>*Dispute Notice</h4>
...
<h3 className={styles.top}>Here is the grievance officer's contact information:</h3>
<h3 className={styles.top}>Grievance Officer: Mr. Abhishek Gupta</h3>
